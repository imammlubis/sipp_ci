<?php
    function message_template($template_config)
    {
        ...
        if($msg_config['type']=='send_activation_link')
        {
            ...
            $result['message'] .= '<p><a href="'.base_url('account/user/active_user').'/'.$msg_config['user_activation_link'].'" target="_blank">Activation Link</a></p>';
        }
        else if($msg_config['type']=='forget_password')
        {
            ...
            $result['message'] .= '<p><a href="'.base_url('account/user/reset_password').'/'.$msg_config['reset_password_link'].'" target="_blank">Reset Password Link</a></p>';
        }
        return $result;
    }
    ...
    function send_email($email_data)
    {
        ...
        $config['smtp_user']    = 'sippminerba@gmail.com';
        //$config['smtp_crypto']  = 'ssl';
        $config['smtp_pass']    = 'jangkrikbos';
        ...
        $CI->email->from('sippminerba@gmail.com', 'Sippminerba');
